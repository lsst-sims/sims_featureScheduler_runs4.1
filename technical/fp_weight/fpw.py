...
def gen_scheduler(args):
    ...
    fileroot, extra_info = set_run_info(dbroot=dbroot, file_end="w%.1fv4.1_" % fpw, out_dir=out_dir)
...
def sched_argparser():
    ...
    parser.add_argument("--fpw", type=float, default=1.5)
    parser.add_argument(
        "--setup_only",
        dest="setup_only",
        default=False,
